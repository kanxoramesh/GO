...
//that Go only runs the selected case, not all the cases that follow. In effect,
//the break statement that is needed at the end of each case in those languages
//is provided automatically in Go. Another important difference is that Go's switch cases need not be constants,
